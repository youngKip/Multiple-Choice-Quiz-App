...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String KEY_QUESTION_LIST = "kewQuestionList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuestionCount = findViewById(R.id.text_view_questionCount);
            ...
            public void onClick(View v) {
                if(!answered){
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()){
                        ...
                        Toast.makeText(QuizActivity.this, "please select one of the choices", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
